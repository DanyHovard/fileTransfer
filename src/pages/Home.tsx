...
import { ArrowRight, Download, QrCode, UploadCloud, X, Check, File as FileIcon, Copy, MessageSquare, ShieldCheck, Pause, Play } from 'lucide-react';
          ...
          {appState === 'LANDING' && (
            ...
            >
              ...
              <div className="w-full min-h-[calc(100vh-80px)] md:min-h-[calc(100vh-96px)] flex flex-col justify-center items-center text-center px-4 relative z-10 max-w-5xl mx-auto py-16 md:py-24">
                 <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[5.5rem] font-sans font-bold tracking-tighter text-white mb-12 leading-[1.05]">
